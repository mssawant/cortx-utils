...
static const struct entity_attrs_items {
  ...
  [PEA_TIME_ATTR_START_M0_OBJ_OP] = { .str = "m0_obj_op_start" },
  [PEA_TIME_ATTR_END_M0_OBJ_OP] = { .str = "m0_obj_op_end" },
  [PEA_TIME_ATTR_START_M0_OP_FINISH] = { .str = "m0_op_finish_start" },
  [PEA_TIME_ATTR_END_M0_OP_FINISH] = { .str = "m0_op_finish_end" },
  [PEA_TIME_ATTR_START_M0_OP_FREE] = { .str = "m0_op_free_start" },
  [PEA_TIME_ATTR_END_M0_OP_FREE] = { .str = "m0_op_free_end" },
  ...
  [PEA_TIME_ATTR_START_M0_OBJ_INIT] = { .str = "m0_obj_init_start" },
  [PEA_TIME_ATTR_END_M0_OBJ_INIT] = { .str = "m0_obj_init_end" },
  [PEA_TIME_ATTR_START_M0_OP_LAUNCH] = { .str = "m0_obj_launch_start" },
  [PEA_TIME_ATTR_END_M0_OP_LAUNCH] = { .str = "m0_obj_launch_end" },
  [PEA_TIME_ATTR_START_M0_OP_WAIT] = { .str = "m0_obj_wait_start" },
  [PEA_TIME_ATTR_END_M0_OP_WAIT] = { .str = "m0_obj_wait_end" },
  [PEA_TIME_ATTR_START_M0_RC] = { .str = "m0_obj_rc_start" },
  [PEA_TIME_ATTR_END_M0_RC] = { .str = "m0_obj_rc_end" },
  [PEA_TIME_ATTR_START_M0_ENTITY_CREATE] = { .str = "m0_entity_create_start" },
  [PEA_TIME_ATTR_END_M0_ENTITY_CREATE] = { .str = "m0_entity_create_end" },
  [PEA_TIME_ATTR_START_M0_ENTITY_DELETE] = { .str = "m0_entity_delete_start" },
  [PEA_TIME_ATTR_END_M0_ENTITY_DELETE] = { .str = "m0_entity_delete_end" },
  [PEA_TIME_ATTR_START_M0_ENTITY_OPEN] = { .str = "m0_entity_open_start" },
  [PEA_TIME_ATTR_END_M0_ENTITY_OPEN] = { .str = "m0_entity_open_end" },
  [PEA_TIME_ATTR_START_M0_FREE] = { .str = "m0_free_start" },
  [PEA_TIME_ATTR_END_M0_FREE] = { .str = "m0_free_end" },
  [PEA_TIME_ATTR_START_M0_ENTITY_FINISH] = { .str = "m0_entity_finish_start" },
  [PEA_TIME_ATTR_END_M0_ENTITY_FINISH] = { .str = "m0_entity_finish_end" },
  [PEA_TIME_ATTR_START_M0_UFID_NEXT] = { .str = "m0_ufid_next_start" },
  [PEA_TIME_ATTR_END_M0_UFID_NEXT] = { .str = "m0_ufid_next_end" },
  [PEA_TIME_ATTR_START_M0_ALLOC_PTR] = { .str = "m0_alloc_ptr_start" },
  [PEA_TIME_ATTR_END_M0_ALLOC_PTR] = { .str = "m0_alloc_ptr_end" },

  [PEA_M0STORE_RES_RC] = { .str = "m0store_result_code" },

  [PEA_TIME_ATTR_START_M0_CLIENT_INIT] = { .str = "m0_client_init_start" },
  [PEA_TIME_ATTR_END_M0_CLIENT_INIT] = { .str = "m0_client_init_end" },
  [PEA_TIME_ATTR_START_M0_CONTAINER_INIT] = { .str = "m0_container_init_start" },
  [PEA_TIME_ATTR_END_M0_CONTAINER_INIT] = { .str = "m0_container_init_end" },
  [PEA_TIME_ATTR_START_M0_FID_SSCANF] = { .str = "m0_fid_sscanf_start" },
  [PEA_TIME_ATTR_END_M0_FID_SSCANF] = { .str = "m0_fid_sscanf_end" },
  [PEA_TIME_ATTR_START_M0_FID_PRINT] = { .str = "m0_fid_print_start" },
  [PEA_TIME_ATTR_END_M0_FID_PRINT] = { .str = "m0_fid_print_end" },
  [PEA_TIME_ATTR_START_M0_IDX_INIT] = { .str = "m0_idx_init_start" },
  [PEA_TIME_ATTR_END_M0_IDX_INIT] = { .str = "m0_idx_init_end" },
  [PEA_TIME_ATTR_START_M0_UFID_INIT] = { .str = "m0_ufid_init_start" },
  [PEA_TIME_ATTR_END_M0_UFID_INIT] = { .str = "m0_ufid_init_end" },
  [PEA_INIT_MOTR_RES_RC] = { .str = "m0_init_motr_result_code" },

  [PEA_TIME_ATTR_START_M0_IDX_OP] = { .str = "m0_idx_op_start" },
  [PEA_TIME_ATTR_END_M0_IDX_OP] = { .str = "m0_idx_op_end" },
  [PEA_TIME_ATTR_START_M0_IDX_FINISH] = { .str = "m0_idx_finish_start" },
  [PEA_TIME_ATTR_END_M0_IDX_FINISH] = { .str = "m0_idx_finish_end" },
